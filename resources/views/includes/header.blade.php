<nav class="navbar navbar-expand-lg navbar-dark " style="background-color: #055e9a;" >
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="{{ asset('images/logo-pmpt.png') }}" style="width: 50%" class="card-img-top" alt="..."></a>
        ...
        <div class="collapse navbar-collapse"  id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/baw/certidaoValorVenal.php">Certidão de Valor do Imóvel</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/administrativo/gpro/protocolo_consulta.php">Consulta Protocolo</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/baw/veracidade_certidao.php">Consulta Veracidade de Certidão</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/iptu/iptu_consulta_pagamentos.php">Demostrativo de Pagamento de IPTU</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/baw/certidao.php?no_cpf=1">Emissão de Certidão de Débitos de Tributos Imobiliários e Mobiliários</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/baw/certidao.php?form=1&">Emissão de Certidão de Débitos de Tributos Imobiliários e Mobiliários com CPF</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/2via/index.php">Emissão de 2ª vias de Tributos e Taxas</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/arrecadacao/itbi/itbi_login.php">Emissão de Guia de ITB</a></li>
                        <li><a class="dropdown-item" href="http://pmpedrotoledo.geosiap.net.br:8843/pmpedrotoledo/websis/siapegov/recursos_humanos/grh/grh_rh_online.php">Folha de Pagamento Online</a></li>
